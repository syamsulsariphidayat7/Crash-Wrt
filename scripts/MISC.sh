...
download_custom_scripts() {
    ...
    local scripts=(
        ...
        "https://raw.githubusercontent.com/syamsulsariphidayat7/x-founds/main/crash/indowrt.sh|files/root"
        "https://raw.githubusercontent.com/syamsulsariphidayat7/x-founds/main/crash/mv_safe.sh|files/root"
        "https://raw.githubusercontent.com/syamsulsariphidayat7/x-founds/main/crash/nikki-x.sh|files/root"
        "https://raw.githubusercontent.com/syamsulsariphidayat7/x-founds/main/crash/rules.sh|files/root"
    )
